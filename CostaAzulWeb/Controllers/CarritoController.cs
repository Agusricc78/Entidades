...
namespace CostaAzulWeb.Controllers
{
    public class CarritoController : Controller
    {
        ...
        //[HttpGet]
        //public IActionResult VerCarritos()
        //{
        //    try
        //    {
        //        string ipUsuario = HttpContext.Connection.RemoteIpAddress?.ToString();
        ...
        //            return Json(new { success = false, message = "Carrito vacío", carrito = modelVacio });
        //        }
        ...
        //        return Json(new { success = true, carrito = model });
        //    }
        //    catch (Exception ex)
        //    {
        ...
        //            Subtotal = 0
        //        };
        //        return Json(new { success = false, message = ex.Message, carrito = modelError });
        //    }
        //}
        ...
        //        if (string.IsNullOrEmpty(ipUsuario) || ipUsuario == "::1")
        //        {
        //            ipUsuario = HttpContext.Request.Headers["X-Forwarded-For"].FirstOrDefault() ?? "192.168.1.100";
        //        }
